<template>
  <div class="modal fade renew-token-modal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Renew Token</h5>
        ...
        <form ref="renewTokenForm" v-if="token">
          <div class="modal-body">
              <modal-alert></modal-alert>

              <p>Are you sure you want to renew this token? The endpoint will change once this action is performed.</p>
          </div>

          <div class="modal-footer">
            <modal-loader v-if="modalLoader"></modal-loader>

            <button :disabled="modalLoader" type="button" class="btn btn-primary" v-on:click="submitRenewToken">Yes</button>
